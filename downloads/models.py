...
class AssetEvent(models.Model):
    asset = models.ForeignKey(DownloadableAsset, on_delete=models.CASCADE, related_name="events")
    kind = models.CharField(max_length=40)  # CLICK, DOWNLOAD, ERROR, VIRUS, REPLACED
