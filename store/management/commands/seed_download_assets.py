...
SAMPLES = {
    "checklists": [
        (
            "Checklist – Structures publiques",
            "Points essentiels pour démarrer le contrôle",
            "checklist_publiques.txt",
            "Item 1\nItem 2\nItem 3\n".encode("utf-8"),
        ),
        (
            "Checklist – Projets financés",
            "Contrôles clés bailleurs",
    ...
    "bonus": [
        (
            "Guide des réponses – Version courte",
            "Exemples de réponses factuelles",
            "bonus_reponses.txt",
            "Q1: ...\nR1: ...\n".encode("utf-8"),
        ),
    ],
    "outils-pratiques": [
        (
            "Plan d’action correctif (exemple)",
    ...
    "irregularites": [
        (
            "Irrégularités fréquentes (extrait)",
            "Tableau de synthèse",
            "irregs.csv",
